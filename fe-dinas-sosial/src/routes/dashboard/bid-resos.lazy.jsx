...
import { MdAccessible, MdTrackChanges } from "react-icons/md";
import AOS from "aos";
...
function Dashboard() {
  ...
  const [view, setView] = useState("penerima");
  const [jumlahPenerima, setJumlahPenerima] = useState(0);
  const [targetPenerima, setTargetPenerima] = useState(0);
  ...
  const fetchDummyData = async () => {
    try {
      ...
      // Data dummy
      setJumlahPenerima(245);
      setTargetPenerima(350);
  ...
  const widgets = [
    {
      id: "penerima",
      title: "Jumlah Penerima Kursi Roda",
      icon: <MdAccessible size={32} />,
      value: loading ? "..." : jumlahPenerima,
      bgColor: "#ff7f0e",
    },
    {
      id: "target",
      title: "Target Penerima Kursi Roda",
      icon: <MdTrackChanges size={32} />,
      value: loading ? "..." : targetPenerima,
      bgColor: "#1F3A93",
    },
  ];
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 max-w-full mx-auto space-y-6">
        ...
        {view === "penerima" && (
          <div className="mt-8" data-aos="fade-up">
            <Card className="p-6">
              <h3 className="text-lg font-semibold mb-4">Data Penerima Kursi Roda</h3>
        ...
        {view === "target" && (
          <div className="mt-8" data-aos="fade-up">
            <Card className="p-6">
              <h3 className="text-lg font-semibold mb-4">Target Penerima Kursi Roda</h3>
              <p className="text-gray-600">
                Abogoboga.
              </p>
            </Card>
